                            ...
                            if (message.toLowerCase().equals("no")) {
                                ...
                                locationManager.requestSingleUpdate(LocationManager.GPS_PROVIDER, new LocationListener() {
                                    ...
                                    public void onLocationChanged(Location location) {
                                        ...
                                        com.example.kiyoon.groupmycontacts.Util.sendSMS(phoneNumber, "Here is the location. We recommend that you call your friend in advance to check up." + latitude + "," + longitude, context);
